...
#|
 ...
 CS 2800 Homework 8 - Fall 2023

 - Due on Tuesday, Nov. 14 by 11:00 PM.
...
#|
 ...
 Your mentor is a compiler wizard.  During one of your onboarding
 meetings, she mentions that she is supporting a compiler that other
 teams are using. However, they generate code using some fancy AI
 techniques, but the code is sometimes very inefficient. Instead of
 having someone go through and optimize it by hand, she really wants
 to write an optimizing compiler for it. The application is really
 critical and she wants to make sure that if there are bugs, it won't
 be due to her compiler, i.e., it will be the AI team's fault (isn't
 always?). Therefore, she made the only reasonable choice and is 
 learning to use ACL2s.
...
#|
 ...
 that all of her optimizations are valid. This is right up your ally,
...
#|
 ...
 1. When you have named properties like the ones above, it matters, a
    lot, the order of arguments to equalities. Why? Because ACL2s uses
 ...
 2. You don't really have to worry too much about that here, since
    your mentor is writing a compiler and she'll figure out how to
...
#|
 ...
 transformations she wants to perform. See hwk08.proof.
